...
void main(){
  runApp(MaterialApp(debugShowCheckedModeBanner: false,home: ital(),));
}


class ital extends StatelessWidget{
  @override
  Widget build(BuildContext context) {
    return Scaffold(
     body: Column(
       children: [
         Image.asset('assets/italy.png'),
         Padding(
           padding: const EdgeInsets.all(8.0),
           child: Align(child: Text('Italy',style: TextStyle(
               fontSize: 25,fontWeight: FontWeight.bold),),
             alignment: Alignment.topLeft,),
         ),
         Text('Italy, a European country with a long Mediterranean coastline, '
