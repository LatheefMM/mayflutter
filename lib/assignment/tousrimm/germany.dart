...
void main(){
  runApp(MaterialApp(debugShowCheckedModeBanner: false,home: ger(),));
}
      ...
      body: Column(
        children: [
          ...
          Padding(
            ...
            child: Align(child: Text('Germany',style: TextStyle(
                fontSize: 25,fontWeight: FontWeight.bold),),
              alignment: Alignment.topLeft,),
          ),
          Text('Germany, a European country with a long Mediterranean coastline, '
