...
void main(){
  runApp(MaterialApp(debugShowCheckedModeBanner: false,home: fra(),));
}
      ...
      body: Column(
        children: [
          ...
          Padding(
            ...
            child: Align(child: Text('France',style: TextStyle(
                fontSize: 25,fontWeight: FontWeight.bold),),
              alignment: Alignment.topLeft,),
          ),
          Text('France is a European country with a long Mediterranean coastline, '
