...
import 'package:mayflutter/assignment/booking/hotelpackages.dart';
import 'package:mayflutter/assignment/booking/popularhotel.dart';
      ...
      body: CustomScrollView(slivers: <Widget>[
            ...
            actions: [
              Padding(
                ...
                child: ClipRRect(
                    ...
                    child: Image.asset("assets/italy5.png")),
              ),
            ],
            bottom: AppBar(
                elevation: 5,
        ...
        SliverList(
            delegate: SliverChildBuilderDelegate(
                  (context, index) => hotie(index: index),
              childCount:5,
            ))]
      ),
